...
export default function About() {
    return (
        <section className="max-w-screen-2xl flex gap-5 min-h-screen p-4">
            {/* Left Side */}
            <div className="w-7/12 bg-[#fbddd1] rounded-xl relative overflow-hidden">
                <h1 className='font-semibold text-6xl px-10 py-20 leading-tight'>
            ...
            <div className="flex-1 bg-design-color p-10 rounded-xl">
                <div className='bg-white w-full h-full rounded-xl p-10 space-y-6 shadow-md flex flex-col justify-center gap-5'>
                    ...
                    {/* Stats Section */}
                    <div className='flex justify-between border-y-2 border-gray-300 py-6'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <ul>
                            <li className='flex items-center gap-2 text-xl text-gray-600'><MdOutlineDone /> Loan & low Interest facility</li>
                            <li className='flex items-center gap-2 text-xl text-gray-600'> <MdOutlineDone /> Over 100k+ property & update regularly</li>
                            <li className='flex items-center gap-2 text-xl text-gray-600'><MdOutlineDone /> Expert agent consultation</li>
                        </ul>
                    </div>
                    {/* button */}
